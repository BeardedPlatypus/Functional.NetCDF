...
type internal File (ncId: NcID) =
    ...
    interface IFile with
        ...
        member this.RetrieveVariableValueInt (variableID: VarID) (valueSize: int) : Result<int32[], NCReturnCode> =
            let resultArray = Array.zeroCreate valueSize
        ...
        member this.RetrieveVariableValueChar (variableID: VarID) (valueSize: int) : Result<byte[], NCReturnCode> =
            let resultArray = Array.zeroCreate valueSize
        ...
        member this.RetrieveVariableValueUInt (variableID: VarID) (valueSize: int) : Result<uint32[], NCReturnCode> =
            let resultArray = Array.zeroCreate valueSize
            let returnCode = nc_get_var_uint(localId, variableID.ToInt(), resultArray)
            toResult id returnCode resultArray

        member this.RetrieveVariableValueULong (variableID: VarID) (valueSize: int) : Result<uint64[], NCReturnCode> =
            let resultArray = Array.zeroCreate valueSize
            let returnCode = nc_get_var_ulong(localId, variableID.ToInt(), resultArray)
            toResult id returnCode resultArray
